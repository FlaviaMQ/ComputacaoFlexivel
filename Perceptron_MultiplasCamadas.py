...
dados = pd.read_excel("Conforto-Termico-anapolis.xlsm", sheet_name="treino3")

dados = dados.dropna(subset=["Mes", "Hora", "Temperatura", "Classe"])
...
X = dados[["Mes_sen", "Mes_cos", "Hora_sen", "Hora_cos", "Temperatura"]]
y = dados["Classe"]
